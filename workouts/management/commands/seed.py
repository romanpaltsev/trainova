...
CHANGELOG = [
    (
        ...
        "Подготовка тренировки заранее",
        "Тренировку можно собрать дома: в модалке «+» переключитесь на «Подготовить» "
        "и добавьте упражнения — время не идёт. В зале останется нажать "
        "«Начать тренировку», и отсчёт пойдёт с этого момента.",
        date(2026, 8, 30),
    ),
    (
        ChangelogEntry.Kind.FEATURE,
